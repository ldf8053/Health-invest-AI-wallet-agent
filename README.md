...
✅ Pitch do proejto: Ouça a apresentação da Mari 

[Clique aqui para ouvir o pitch](audio/pitch_mari.mp3)

Transcrição: Olá! Eu gostaria de apresentar a Mari, uma agente de Inteligência Artificial desenvolvida para atuar como educadora financeira especializada em investimentos em saúde.
Muitas pessoas desejam cuidar melhor da saúde, mas nem sempre conseguem organizar seus gastos ou entender quais serviços e produtos fazem sentido para seus objetivos. Além disso, modelos de IA tradicionais podem gerar respostas imprecisas ou inventar informações, algo especialmente delicado quando falamos de saúde e finanças. Foi pensando nisso que desenvolvi a Mari. A Mari é uma agente conversacional construída em Python, utilizando Streamlit para a interface e o modelo Gemini 2.5 Flash para geração das respostas. O diferencial da solução é que ela trabalha com uma base de conhecimento controlada. Todas as respostas são geradas utilizando apenas as informações armazenadas localmente no projeto, como o perfil do usuário, seu histórico financeiro e os produtos e serviços disponíveis. Isso reduz significativamente o risco de alucinações e torna as respostas mais seguras e contextualizadas. Quando o usuário faz uma pergunta, a Mari reúne as informações da base de conhecimento, monta um contexto personalizado e envia esse contexto juntamente com regras de comportamento para o modelo de linguagem. Em seguida, ela retorna uma resposta clara, amigável e educativa. Além disso, a Mari foi projetada com algumas restrições importantes: ela não inventa custos, não recomenda medicamentos ou tratamentos específicos e sempre incentiva o acompanhamento de profissionais da saúde. Entre as tecnologias utilizadas estão Python, Streamlit, Pandas e a API do Google Gemini. Mais do que responder perguntas, a proposta da Mari é ajudar as pessoas a desenvolverem hábitos financeiros mais conscientes e entenderem que investir em saúde também é investir em qualidade de vida. No futuro, a solução pode evoluir para incluir memória de conversas, dashboards financeiros, recomendações proativas e integração com outras ferramentas de IA. A Mari representa uma aplicação prática de IA Generativa aliada à segurança, personalização e educação financeira, mostrando como a tecnologia pode apoiar decisões mais conscientes e sustentáveis para a saúde das pessoas. Muito obrigada!
